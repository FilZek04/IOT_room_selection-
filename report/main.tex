...
We maintained a live Gantt chart tracking all 37 tasks across the nine epics. The chart is deployed at \url{https://fede-oss.github.io/iot/} and driven by a structured \texttt{tasks.json} file versioned in the repository.
